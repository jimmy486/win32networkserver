========================================================================
    控制台应用程序 : UdpServer 项目概况
========================================================================

应用程序向导已为您创建了这个 UdpServer 应用程序。
此文件包含组成 UdpServer 应用程序
的每个文件的内容摘要。
...
<win_app event='64' style='4026531843'><item bshow='1' /></win_app>